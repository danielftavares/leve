...
public class Criteria implements Cloneable {
     ...
     * @see Projection
     * @see org.leve.criteria.projection.Projections
     */
    ...
    public Criteria removeMaxResults(int maxResults) {
    ...
    public Criteria removeFirstResult() {
